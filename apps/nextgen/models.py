...
class Presence(models.Model):
    ...
    entry = models.ForeignKey(ScanDocketEntry, on_delete=models.DO_NOTHING, editable=False)
    date = models.DateField(editable=False)
    text = models.CharField(editable=False)
    case = models.ForeignKey(CourtCase, on_delete=models.DO_NOTHING, editable=False)
